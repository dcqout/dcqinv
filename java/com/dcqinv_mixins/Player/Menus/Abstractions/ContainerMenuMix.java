...
public abstract class ContainerMenuMix implements IContainerMenu {
    ...
    @Overwrite public Slot addSlot(Slot slot) {
        if (slot.index == 500) { return slot; }
    ...
    @Overwrite
    public void addInventoryHotbarSlots(Container container, int x, int y) {
        for(int i = 0; i < 9; ++i) {
    ...
    @Overwrite
    public void addInventoryExtendedSlots(Container container, int x, int y) {
    ...
    @Overwrite
    public void addStandardInventorySlots(Container container, int x, int y) {
