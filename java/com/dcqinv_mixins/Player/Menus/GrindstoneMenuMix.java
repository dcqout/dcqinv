...
public abstract class GrindstoneMenuMix extends AbstractContainerMenu {
    ...
    @Shadow final Container repairSlots; @Shadow private final ContainerLevelAccess access; @Shadow private int xp;
    ...
    public Slot Slotn3(Slot arg) {
        ...
        @Override public void onTake(Player p_150574_, ItemStack p_150575_) {
            if (net.neoforged.neoforge.common.CommonHooks.onGrindstoneTake(repairSlots,access,this::getExperienceAmount)) return;
