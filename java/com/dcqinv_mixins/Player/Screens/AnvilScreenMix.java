...
public abstract class AnvilScreenMix extends ItemCombinerScreen<AnvilMenu> implements IGuiGraphics {
    ...
    @Override
    public void renderBg(GuiGraphics p_283345_, float p_283412_, int p_282871_, int p_281306_) {
    ...
    @Override
    public void renderLabels(GuiGraphics guiGraphics, int p_282417_, int p_283022_) {
    ...
    @Override
    public void renderErrorIcon(GuiGraphics guiGraphics, int i, int i1) {
