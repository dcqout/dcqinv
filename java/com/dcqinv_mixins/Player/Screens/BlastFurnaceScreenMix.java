...
public abstract class BlastFurnaceScreenMix extends AbstractFurnaceScreen<BlastFurnaceMenu> implements IGuiGraphics {
    public BlastFurnaceScreenMix(BlastFurnaceMenu menu, Inventory playerInventory, Component title, Component recipeFilterName, ResourceLocation texture, ResourceLocation litProgressSprite, ResourceLocation burnProgressSprite, List<RecipeBookComponent.TabInfo> tabInfos) {
    ...
    @Override
    public void renderBg(GuiGraphics p_282928_, float p_281631_, int p_281252_, int p_281891_) {
